...
def convert_img_to_video(images_folder, destination_video_fps, destination_video_name):
    """
    #  PARAMETERS EXAMPLE
    images_folder   = 'D:\\Datasets\\UAV-benchmark-M\\UAV-benchmark-M\\M0209\\'
    destination_video_fps = 30
    destination_video_name = "\\output\\destination_video"+".avi"
    """
